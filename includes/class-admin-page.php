...
final class Admin_Page {
	...
	public function download() {
		...
		$this->stream_zip_file( $bundle_path, basename( $bundle_path ) );
	}

	/**
	 * Stream an authenticated ZIP download response.
	 *
	 * @param string $bundle_path File path.
	 * @param string $filename Download filename.
	 */
	private function stream_zip_file( $bundle_path, $filename ) {
		...
		header( 'Content-Disposition: attachment; filename="' . $this->header_filename( $filename ) . '"' );
